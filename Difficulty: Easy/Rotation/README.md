<h2><a href="https://www.geeksforgeeks.org/problems/rotation4723/1?page=1&category=Arrays&difficulty=School,Basic,Easy&status=unsolved&sortBy=submissions">Rotation</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an ascending sorted rotated array&nbsp;<strong>arr </strong>of distinct integers of size <strong>n</strong>. The array is right-rotated <strong>k</strong> times. Find the value of <strong>k</strong>.</span></p>
